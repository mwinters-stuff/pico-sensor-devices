...
*/
/**************************************************************************/
void VEML6070::begin(i2c_inst_t* i2c, veml6070_integrationtime_t itime
                              ) {
  _i2c.begin(i2c);
...
*/
/**************************************************************************/
void VEML6070::setInterrupt(bool state, bool level) {
...
void VEML6070::waitForNext() {
  ...
  for (uint8_t i = 0; i < itCount; i++) {
    _sleep_ms(63); // Depends on RSET = 270K, note actual time is shorter
...
*/
/**************************************************************************/
void VEML6070::sleep(bool state) {
