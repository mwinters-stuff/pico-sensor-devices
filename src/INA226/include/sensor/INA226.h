...
class INA226
{
	...
	bool begin(i2c_inst_t* i2c, uint8_t address = INA226_ADDRESS);
...
private:
  ...
  ina226_averages_t config_avg;
  ina226_busConvTime_t config_busConvTime;
  ina226_shuntConvTime_t config_shuntConvTime;
  ina226_mode_t config_mode;
